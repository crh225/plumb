...
| **v5** (+ long documents) | 5,026 | 1.000 | 0.972 | **0.802** | 0.094 | **0.846** |
...
the questions the starting model gets wrong or is unsure of, was the first to move it (86 of 111).
v5 adds twice the teacher questions and JevBench-length documents: 89 of 111 against the starting
point's 82, with 8 items fixed and 1 broken (exact McNemar p = 0.039). Long policies go 11 -> 14,
probability 7 -> 10, trade-offs 5 -> 6; dates and numbers stay at 7 of 15. v5 is chosen on the
held-out check, where it leads v4 in accuracy and calibration. Its public hard-tier calibration
error (0.094) is worse than v4's; its temperature stays as fitted on held-out data.
...
[v5 model card](bench/out/v5/MODEL_CARD.md), [system card](bench/out/v5/SUBMISSION.md).
...
**v5: long documents help.** 5,026 teacher questions (500 with 1,500-2,800-word documents),
hard-mined to 3,204 plus as much replay, 3 epochs at 3e-5, temperature 2.07: held-out 0.846,
public hard tier 0.802. The long-document gain shows where it was aimed, long policies 11 -> 14.
