...
- **Data:** decisions written by Qwen3.8-27B (FP8, vLLM) with thinking, each question solved twice
  ...
  Hard mining: of 2538 kept teacher questions, JevK5 answered 655 wrong and was unsure (<0.8 on the right answer) on 664; those, plus a random quarter of the rest, form the teacher part of the training set.
